<template>
  <div
    ...
    class="w-full bg-gray-700 ml-2 rounded-xl h-full shadow-sm"
  >
    <div class="border-b">
      <div class="flex rounded-t-xl bg-gray-800 items-center justify-between px-1.5 py-0.5">
        <div class="flex">
    ...
    <div class="w-full text-xl ml-20 font-light pt-5 text-white">
      {{ email.subject }}
    </div>
    ...
    <div class="w-full flex">
      ...
      <div class="w-full my-4 mx-0.5">
        ...
        <div class="text-gray-300">{{ email.body }}</div>
      </div>
    </div>
  </div>
</template>
